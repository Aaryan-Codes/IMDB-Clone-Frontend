...
const TVshowDetail = () => {
  ...
  useEffect(() => {
    fetch(
      `https://api.themoviedb.org/3/tv/${params.showID}?api_key=0b350f5e45fb6aafe713b2af67a113d2`
    )
      .then((res) => res.json())
  ...
  return (
    <div className="movie">
      ...
      <div className="movie__detail">
        ...
        <div className="movie__detailRight">
          ...
          <div className="movie__detailRightBottom">
            ...
            <div>{movieDet ? movieDet.overview : ""}</div>
          </div>
        </div>
      </div>
      ...
      {/* <SimilarSuggestions prop={movieDet} /> Work on this feature later  */}
    </div>
  );
};
